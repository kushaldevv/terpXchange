...
//                        } else {
//
//                            Text("hi there how are you today good sir lol. more stuff stuff")
...
//                                    .font(.system(size: 23))
//                                    .foregroundColor(isAnimating ? .white : .blue)
//                                    .offset(x: -80)
//                            }
//                            .frame(width: 200)
//                            .animation(.easeInOut(duration: 5.9), value: isAnimating)
//                            .scaleEffect(isAnimating ? 5.2 : 1.0)
//                            .onTapGesture {
